...
File structure borrowed from the Dragonfly project. `package.json` will likely be the same, but otherwise, all other files will be removed and replaced with relevant files. Current setup is a Rails Backend and a React FrontEnd. Although a backend might not be required. 
